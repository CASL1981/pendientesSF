    ...
    <x-slot name="content">
        <form>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    <x-form.label for="rol_auditor">Rol Audito</x-form.label>
                    <x-select wire:model="rol_auditor" class="form-control-sm" id="rol_auditor"
                    :options="['Auditor Lider' => 'Auditor Lider', 'Auditor' => 'Auditor', 'Observador' => 'Observador']" placeholder="Seleccione..."/>
                    <x-form.input-error for="rol_auditor"/>
                </div>
                <div class="form-group col-md-4">
