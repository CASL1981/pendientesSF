<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('shopping.products'))}}" href="{{ route('shopping.products') }}" >
            <i class="icon">
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">Modulos</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('shopping'))}}" href="{{ route('shopping') }}" >
            <i class="icon">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('dashboard.destinations'))}}" href="" >
            <i class="icon">
                <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
